...
class Main extends PluginBase
{
    ...
    public $enchants = [
        ...
        CustomEnchantsIds::CACTUS => ["Cactus", "Armor", "Equip", "Rare", 2, "Poke people around you", "Poke people around you"],
        CustomEnchantsIds::CHARGE => ["Charge", "Weapons", "Damage", "Uncommon", 10, "Increases damage when sprinting"],
        CustomEnchantsIds::CHICKEN => ["Chicken", "Chestplate", "Equip", "Uncommon", 50, "Lays egg every 5 minutes, 5l% (l = level) chance of rare drop"],
        ...
        CustomEnchantsIds::LUMBERJACK => ["Lumberjack", "Axe", "Break", "Rare", 5, "Mines all logs connected to log when broken"],
        ...
        CustomEnchantsIds::OVERLOAD => ["Overload", "Armor", "Equip", "Mythic", 50, "Gives 1 extra heart per level per armor piece"],
        ...
        CustomEnchantsIds::WITHER => ["Wither", "Weapons", "Damage", "Uncommon", 10, "Gives enemies wither"],
        CustomEnchantsIds::WITHERSKULL => ["Wither Skull", "Bow", "Shoot", "Mythic", 1, "Shoots Wither Skull"],
        CustomEnchantsIds::PLACEHOLDER => ["Placeholder", "Bow", "Shoot", "Rare", 1000, ""]
    ];
